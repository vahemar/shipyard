        ...
        <Flex w={'full'}>
            <Flex display={['none', 'none', 'none', 'none', 'flex']} w={'full'} align={'center'}>
                ...
                <Flex w={'full'} pos={'absolute'} gap={24} justify={'space-between'} p={20} align={'center'} >
                    ...
                    <Flex gap={4} w={'full'} justify={'flex-end'} align={'center'} flexWrap={'wrap'} >
                        {
            ...
            <Flex display={['flex', 'flex', 'flex', 'flex', 'none']} w={'full'} align={'center'}>
                ...
                <Flex gap={6} w={'full'} pos={'absolute'} justify={'space-between'} direction={'row'} p={4} align={'center'} >
                    <Flex w={'full'} flexWrap={'wrap'} direction={'column'} align={'flex-start'} gap={2}>
                        <Text fontSize={'18px'} fontWeight={700} color={'white'} textAlign={'flex-start'}>Тавимский морской порт VISMA</Text>
                        <Text color={'white'} fontSize={'12px'} fontWeight={400}>Vel posuere nibh odio placerat massa vel tellus tortor. Varius eget nunc scelerisque etiam felis facilisi ante viverra sem.</Text>
                    </Flex>
                    <Flex justify={'center'} align={'center'} gap={4}>
                        <Text textTransform={'uppercase'} fontWeight={700} fontSize={'16px'} lineHeight={'24px'} color={'white'}>компания</Text>
                        <ArrowRight />
                    </Flex>
                </Flex>
            </Flex>
